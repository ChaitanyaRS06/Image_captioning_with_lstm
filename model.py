...
class BahdanauAttention(tf.keras.Model):
    ...
    def call(self, features, hidden):
        ...
        #attention_weights = tf.nn.relu(self.V(score), axis=1)
...
class RNN_Decoder(tf.keras.Model):
    def __init__(self , embedding_dim, units, vocab_size):
       ...
       # print("Embedding layer shape:",self.embedding.shape)
        self.GRU = tf.keras.layers.LSTM(self.units,
                                       return_sequences=True,
                                       return_state=True,
                                       recurrent_initializer="orthogonal")
        #print("GRU layer shape:",self.GRU.shape)
    ...
    def call(self, x, features, hidden):
        ...
        output, state , trainbatch = self.GRU(x)
